...
class _FeelingFabHub extends StatelessWidget {
  ...
  List<Widget> _tiles(BuildContext context) => [
    ...
    _HubTile(emoji: '🌙', label: 'Sleep Den',        accentColor: _amber,  onTap: () => onNavigate(const SleepScreen())),
    ...
    _HubTile(emoji: '🩹', label: 'Feeling Better',   accentColor: _green,  onTap: () => onNavigate(const RecoveryScreen())),
