  ...
  Widget _buildAboutSection() {
    return _Section(
      ...
      child: Column(children: [
        ...
        const Divider(color: Colors.white10, height: 20),
        _aboutRow(Icons.lock_outline_rounded, _teal, 'Privacy', 'Your information is saved here for this app. Ask a trusted grown-up before sharing it.'),
        const Divider(color: Colors.white10, height: 20),
        _aboutRow(Icons.star_rounded, _amber, 'Stars', 'Stars can appear after some check-ins, games and garden discoveries.'),
        const Divider(color: Colors.white10, height: 20),
